...
fn setup_07_internationalized_domain_name() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_07_internationalized_domain_name_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_07_internationalized_domain_name();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),Some(r#"example.xn--fiqs8s"#.to_string()),Some(r#"http"#.to_string()),None,None,None);
...
#[test]
fn test_07_internationalized_domain_name_2() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_07_internationalized_domain_name();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo2"#), r#"/foo2"#.to_string(),Some(r#"example.xn--fiqs8s"#.to_string()),Some(r#"http"#.to_string()),None,None,None);
    ...
    let target_header = headers.first().unwrap();
    assert_eq!(target_header.name, "Location");
    assert_eq!(target_header.value, r#"/bar2"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}
...
fn test_action_custom_body_1() {
    ...
    let value = header_map.get_all(r#"Content-Type"#).iter().find(|x| x.as_str() == r#"application/json"#);
...
fn test_action_custom_body_2() {
    ...
    let value = header_map.get_all(r#"Content-Type"#).iter().find(|x| x.as_str() == r#"text/javascript"#);
...
fn test_action_filter_header_add_1() {
    ...
    let value = header_map.get_all(r#"X-Foo"#).iter().find(|x| x.as_str() == r#"foo1"#);

    assert!(value.is_some());

    let value = header_map.get_all(r#"X-Foo"#).iter().find(|x| x.as_str() == r#"foo2"#);
...
fn setup_action_filter_header_default() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"header_filters":[{"action":"default","header":"X-Foo","value":"foo2"}],"id":"action-header-default","rank":2,"source":{"path":"/foo"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_filter_header_default_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_filter_header_default();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_action_filter_header_default_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_action_filter_header_remove() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"header_filters":[{"action":"remove","header":"X-Foo","value":""}],"id":"action-header-remove","rank":2,"source":{"path":"/foo"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_filter_header_remove_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_filter_header_remove();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
    ...
    let value = header_map.get_all(r#"X-Bar"#).iter().find(|x| x.as_str() == r#"bar"#);
...
fn setup_action_filter_header_replace() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"header_filters":[{"action":"replace","header":"X-Foo","value":"foo2"}],"id":"action-header-replace","rank":2,"source":{"path":"/foo"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_filter_header_replace_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_filter_header_replace();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_action_filter_header_replace_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_action_html_legacy_body_end() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"body_filters":[{"action":"append_child","css_selector":"","element_tree":["html","body"],"value":"<h1>Append</h1>"}],"id":"html-rule","rank":0,"source":{"path":"/"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_html_legacy_body_end_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_html_legacy_body_end();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/"#), r#"/"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_action_html_legacy_body_end_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_action_html_legacy_body_start() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"body_filters":[{"action":"prepend_child","css_selector":"","element_tree":["html","body"],"value":"<h1>Prepend</h1>"}],"id":"html-rule","rank":0,"source":{"path":"/"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_html_legacy_body_start_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_html_legacy_body_start();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/"#), r#"/"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_action_html_legacy_body_start_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_action_html_legacy_head_end() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"body_filters":[{"action":"append_child","css_selector":"","element_tree":["html","head"],"value":"<title>Append</title>"}],"id":"html-rule","rank":0,"source":{"path":"/"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_html_legacy_head_end_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_html_legacy_head_end();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/"#), r#"/"#.to_string(),None,None,None,None,None);
    ...
    let mut new_body = body_filter.filter(r#"<html><head></head></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"<html><head><title>Append</title></head></html>"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

#[test]
fn test_action_html_legacy_head_end_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let mut new_body = body_filter.filter(r#"<html><head><meta>Exist</meta></head></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"<html><head><meta>Exist</meta><title>Append</title></head></html>"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

fn setup_action_html_legacy_head_start() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"body_filters":[{"action":"prepend_child","css_selector":"","element_tree":["html","head"],"value":"<title>Prepend</title>"}],"id":"html-rule","rank":0,"source":{"path":"/"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_html_legacy_head_start_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_html_legacy_head_start();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/"#), r#"/"#.to_string(),None,None,None,None,None);
    ...
    let mut new_body = body_filter.filter(r#"<html><head></head></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"<html><head><title>Prepend</title></head></html>"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

#[test]
fn test_action_html_legacy_head_start_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let mut new_body = body_filter.filter(r#"<html><head><meta>Exist</meta></head></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"<html><head><title>Prepend</title><meta>Exist</meta></head></html>"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}
...
fn setup_action_html_to_markdown() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"body_filters":[{"action":"html_to_markdown"}],"id":"html-rule","rank":0,"source":{"path":"/"}}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_action_html_to_markdown_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_action_html_to_markdown();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/"#), r#"/"#.to_string(),None,None,None,None,None);
    ...
    let mut new_body = body_filter.filter(r#"<html><body><h1>Title</h1></body></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"# Title
"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

#[test]
fn test_action_html_to_markdown_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let mut new_body = body_filter.filter(r#"<html><body></body></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#""#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

#[test]
fn test_action_html_to_markdown_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_action_html_to_markdown_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let mut new_body = body_filter.filter(r#"<html><head><title>Page title</title></head><body><h1>Title</h1><h2>Exists</h2></body></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"---
title: Page title
---
...
#[test]
fn test_action_html_to_markdown_5() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let mut new_body = body_filter.filter(b"".to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&new_body, b"");

    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

#[test]
fn test_action_html_to_markdown_6() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn test_action_stop_1() {
    ...
    let value = header_map.get_all(r#"X-Foo"#).iter().find(|x| x.as_str() == r#"foo"#);
...
fn setup_ignore_all_query_parameters() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":true,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":false,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_ignore_all_query_parameters_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_ignore_all_query_parameters();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_ignore_all_query_parameters_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_ignore_all_query_parameters_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_ignore_all_query_parameters_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    let target_header = headers.first().unwrap();
    assert_eq!(target_header.name, "Location");
    assert_eq!(target_header.value, r#"/bar?param2=value1&param1=value2"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}

fn setup_ignore_path_case() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":true,"ignore_query_param_order":true,"marketing_query_params":["test"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_case() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":false,"ignore_path_and_query_case":true,"ignore_query_param_order":true,"marketing_query_params":[],"pass_marketing_query_params_to_target":false}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn test_marker_in_header_filter_1() {
    ...
    let value = header_map.get_all(r#"X-Test"#).iter().find(|x| x.as_str() == r#"source"#);
...
fn setup_marketing_parameters() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["param1","param2"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marketing_parameters_notarget() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["param1","param2"],"pass_marketing_query_params_to_target":false}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marketing_parameters_with_catch_all() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_campaing","utm_content","utm_medium","utm_source","utm_term"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_no_marketing_parameterst() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":false,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["param1","param2"],"pass_marketing_query_params_to_target":false}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_query_parameters_order() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":false,"marketing_query_params":["param1","param2"],"pass_marketing_query_params_to_target":false}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_query_parameters_order_1() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_query_parameters_order_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_query_parameters_order_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_query_parameters_order_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_query_parameters_order_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_query_parameters_order_6() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_any_host_match() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":true,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":false,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":[],"pass_marketing_query_params_to_target":false}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_rule_date_trigger_after() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_after_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_after();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_after_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-01T14:30:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_after_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-15T00:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_after_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2019-12-31T14:30:00+00:00"#.to_string()));
...
fn setup_rule_date_trigger_before() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_before_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_before();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_before_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_before_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_before_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_before_5() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2019-08-31T14:00:00+00:00"#.to_string()));
...
fn setup_rule_date_trigger_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_between();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-01T00:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-10T14:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_between_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_date_trigger_equals() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_equals_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_equals();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_equals_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_equals_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-02T14:30:00+00:00"#.to_string()));
...
fn setup_rule_date_trigger_multiple() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_multiple_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_multiple();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
    
    request.set_created_at(Some(r#"2023-02-26T22:30:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_multiple_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_multiple_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2023-03-12T22:30:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_multiple_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2023-02-24T22:30:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_multiple_5() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2023-02-26T12:30:00+00:00"#.to_string()));
...
fn setup_rule_date_trigger_not_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_not_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_not_between();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_not_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_not_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_not_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-15T12:00:01+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_not_between_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_date_trigger_not_equals() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_not_equals_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_not_equals();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_date_trigger_not_equals_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_date_trigger_not_equals_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_date_trigger_weekdays() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_date_trigger_weekdays_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_date_trigger_weekdays();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
    
    request.set_created_at(Some(r#"2023-02-19T17:56:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_weekdays_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2023-02-20T14:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_weekdays_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2023-02-23T00:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_date_trigger_weekdays_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_datetime_trigger_after() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_datetime_trigger_after_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_datetime_trigger_after();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_datetime_trigger_after_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_after_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_after_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_datetime_trigger_before() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_datetime_trigger_before_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_datetime_trigger_before();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_datetime_trigger_before_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_before_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_before_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_before_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_datetime_trigger_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_datetime_trigger_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_datetime_trigger_between();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_datetime_trigger_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_between_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_datetime_trigger_not_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_datetime_trigger_not_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_datetime_trigger_not_between();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_datetime_trigger_not_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_not_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_not_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_datetime_trigger_not_between_5() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_host_default_port() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);

    let route_1: Rule = serde_json::from_str(r#"{"id":"rule-with-default-https-port","rank":0,"source":{"host":"example.org","path":"/foo"},"status_code":302,"target":"/bar"}"#).expect("cannot deserialize");
    router.insert(route_1);
...
#[test]
fn test_rule_host_default_port_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_host_default_port();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),Some(r#"example.org"#.to_string()),Some(r#"https"#.to_string()),None,None,None);
...
#[test]
fn test_rule_host_default_port_2() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_host_default_port();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),Some(r#"example.org:443"#.to_string()),Some(r#"https"#.to_string()),None,None,None);
...
#[test]
fn test_rule_host_default_port_3() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_host_default_port();
    let default_config = RouterConfig::default();
    let request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),Some(r#"example.org:8080"#.to_string()),Some(r#"https"#.to_string()),None,None,None);
...
fn setup_rule_time_trigger_after() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_time_trigger_after_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_time_trigger_after();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_time_trigger_after_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-01T15:21:00+00:00"#.to_string()));
...
#[test]
fn test_rule_time_trigger_after_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-15T14:30:00+00:00"#.to_string()));
...
#[test]
fn test_rule_time_trigger_after_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-15T15:21:00+00:00"#.to_string()));
...
fn setup_rule_time_trigger_before() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_time_trigger_before_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_time_trigger_before();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_time_trigger_before_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_time_trigger_before_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_time_trigger_before_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn setup_rule_time_trigger_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_time_trigger_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_time_trigger_between();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
    
    request.set_created_at(Some(r#"2020-01-01T14:40:00+00:00"#.to_string()));
...
#[test]
fn test_rule_time_trigger_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-10-15T14:55:00+00:00"#.to_string()));
...
#[test]
fn test_rule_time_trigger_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-01T13:00:00+00:00"#.to_string()));
...
#[test]
fn test_rule_time_trigger_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
    ...
    request.set_created_at(Some(r#"2020-01-15T16:00:00+00:00"#.to_string()));
...
fn setup_rule_time_trigger_not_between() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"always_match_any_host":false,"ignore_all_query_parameters":false,"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"ignore_query_param_order":true,"marketing_query_params":["utm_source","utm_medium","utm_campaign","utm_term","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
#[test]
fn test_rule_time_trigger_not_between_1() {
    let _ = tracing_subscriber::fmt::try_init();

    let router = setup_rule_time_trigger_not_between();
    let default_config = RouterConfig::default();
    let mut request = Request::new(PathAndQueryWithSkipped::from_config(&default_config, r#"/foo"#), r#"/foo"#.to_string(),None,None,None,None,None);
...
#[test]
fn test_rule_time_trigger_not_between_2() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_time_trigger_not_between_3() {
    let _ = tracing_subscriber::fmt::try_init();
...
#[test]
fn test_rule_time_trigger_not_between_4() {
    let _ = tracing_subscriber::fmt::try_init();
...
fn test_variable_body_html_4() {
    ...
    let mut new_body = body_filter.filter(r#"<html><body><h2>H2</h2><h1>H1</h1><h1>H1V2</h1></body></html>"#.as_bytes().to_vec(), None);
    new_body.extend(body_filter.end(None));
    assert_eq!(&String::from_utf8(new_body).unwrap(), r#"<html><body><h2>H1V2</h2><h1>H1</h1><h1>H1V2</h1></body></html>"#);
    assert_eq!(action.should_log_request(true, response_status_code, None), true);
}
