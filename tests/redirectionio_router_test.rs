...
fn setup_00_common_rules() -> Router<Rule> {
    ...
    router.insert(route_1.to_route());
...
fn setup_01_straight_rule_match() -> Router<Rule> {
    ...
    router.insert(route_2.to_route());
    ...
    router.insert(route_3.to_route());
    ...
    router.insert(route_4.to_route());
    ...
    router.insert(route_5.to_route());
    ...
    router.insert(route_6.to_route());
    ...
    router.insert(route_7.to_route());
    ...
    router.insert(route_8.to_route());
    ...
    router.insert(route_9.to_route());
    ...
    router.insert(route_10.to_route());
    ...
    router.insert(route_11.to_route());
    ...
    router.insert(route_12.to_route());
    ...
    router.insert(route_13.to_route());
...
fn setup_marker_type_string() -> Router<Rule> {
    ...
    router.insert(route_14.to_route());
    ...
    router.insert(route_15.to_route());
