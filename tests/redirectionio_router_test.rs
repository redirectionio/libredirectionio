...
fn setup_06_emojis() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_campaign","utm_source","utm_content","utm_medium"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_action_seo_override_og_type() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_source","utm_campaign","utm_medium","utm_content"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
