...
fn setup_01_straight_rule_match() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_medium","utm_content","utm_campaign","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_action_seo_override_og_title() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_campaign","utm_content","utm_source","utm_medium"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_in_body_filter() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_campaign","utm_term","utm_medium","utm_content","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_in_header_filter() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_content","utm_term","utm_campaign","utm_medium","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_transformation_lowercase() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_campaign","utm_content","utm_medium","utm_term","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_transformation_underscorize() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_source","utm_medium","utm_content","utm_campaign"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_type_anything() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_term","utm_content","utm_campaign","utm_medium","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_marker_type_enum() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_campaign","utm_source","utm_term","utm_content","utm_medium"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
...
fn setup_rule_with_response_status_codes() -> Router<Rule> {
    let config: RouterConfig = serde_json::from_str(r#"{"ignore_header_case":false,"ignore_host_case":false,"ignore_marketing_query_params":true,"ignore_path_and_query_case":false,"marketing_query_params":["utm_campaign","utm_medium","utm_term","utm_content","utm_source"],"pass_marketing_query_params_to_target":true}"#).expect("cannot deserialize");
    let mut router = Router::<Rule>::from_config(config);
